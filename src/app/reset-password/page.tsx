...
import { Film, Lock, Loader2, ArrowLeft, CheckCircle2, AlertTriangle, KeyRound } from "lucide-react";
  ...
  useEffect(() => {
    ...
    async function exchangeRecoveryTokens() {
      try {
        ...
        // PKCE flow (email OTP): single-use code.
        if (searchCode) {
        ...
        // Default recovery link flow: tokens live in the URL hash.
        ...
        // Supabase may also deliver tokens via query params on custom redirects.
